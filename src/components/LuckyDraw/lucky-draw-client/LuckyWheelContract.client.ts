...
import {Uint256, Uint128, Addr, AssetInfo, InstantiateMsg, Cell, ExecuteMsg, Binary, Cw20ReceiveMsg, QueryMsg, Config, Uint64, Spin, State, WheelCell} from "./LuckyWheelContract.types";
...
export interface LuckyWheelContractInterface extends LuckyWheelContractReadOnlyInterface {
  ...
  spin: (_fee?: number | StdFee | "auto", _memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
}
export class LuckyWheelContractClient extends LuckyWheelContractQueryClient implements LuckyWheelContractInterface {
  ...
  spin = async (_fee: number | StdFee | "auto" = "auto", _memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      spin: {}
    }, _fee, _memo, _funds);
  };
